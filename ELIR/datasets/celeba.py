...
import os
from ELIR.datasets.dataset import MaskInpaint, BasicLoader, AddGaussianNoise, AddColorization, MaskSqaure, get_latent_cache_paths
from PIL import Image



class CelebADataset(Dataset):
    def __init__(self, image_folder, task, patch_size, use_latent_cache=False):
...
class CelebA(BasicLoader):
    ...
    def create_loaders(self, dataset_params):
        ...
        # Datasets
        dataset = CelebADataset(path, task, patch_size, use_latent_cache=use_latent_cache)
