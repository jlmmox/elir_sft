...
from ELIR.datasets.dataset import aug, BasicLoader, AddGaussianNoise, MaskInpaint, AddColorization, MaskSqaure, get_latent_cache_paths
import os
...
class FFHQDataset(Dataset):
    def __init__(self, image_folder, task, patch_size=512, use_latent_cache=False):
